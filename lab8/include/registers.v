...
`define NETWORK_MEM_BLOCK_ADDR_WIDTH    17
`define NETWORK_MEM_REG_ADDR_WIDTH      6
...
`define NETWORK_MEM_BLOCK_ADDR    17'h00002
...
`define NETWORK_MEM_COMMAND_REG           6'h0
`define NETWORK_MEM_MEM_ADDR              6'h1
`define NETWORK_MEM_MEM_DATA_LSB          6'h2
`define NETWORK_MEM_MEM_DATA_MSB          6'h3
`define NETWORK_MEM_MEM_CTRL              6'h4
`define NETWORK_MEM_PKT_START_DEBUG       6'h5
`define NETWORK_MEM_PKT_END_DEBUG         6'h6
`define NETWORK_MEM_FLAG                  6'h7
`define NETWORK_MEM_FIRST_DATA_DEBUG      6'h8
`define NETWORK_MEM_HEAD_PTR_DEBUG        6'h9
`define NETWORK_MEM_TAIL_PTR_DEBUG        6'ha
`define NETWORK_MEM_PAYLOAD_CYCLES_DEBUG  6'hb
`define NETWORK_MEM_CURR_STATE_DEBUG      6'hc
`define NETWORK_MEM_OUT_WR_CT_DEBUG       6'hd
